      ...
      <header className="sticky top-0 z-30 border-b border-slate-200/70 bg-[#f7f9fc]/86 backdrop-blur-xl dark:border-white/10 dark:bg-[#07101f]/82">
        <div className="mx-auto flex min-h-16 w-full max-w-7xl items-center justify-between gap-3 px-4 sm:gap-4 sm:px-6 lg:px-8">
          ...
          <nav className="hidden items-center gap-6 text-sm font-semibold text-slate-600 md:flex dark:text-slate-300">
            ...
            <Link href="/pricing?returnTo=/" className="hover:text-slate-950 dark:hover:text-white">
              Plan
            </Link>
          </nav>
          ...
          <Link
            ...
            className={cn(
              ...
              "h-10 min-w-[5.25rem] shrink-0 gap-1.5 rounded-full bg-[linear-gradient(135deg,#7ea2ff,#5f7dff_58%,#7b6dff)] px-3 text-[14px] font-bold text-[#06101f] shadow-[0_14px_34px_-14px_rgba(96,125,255,0.95),inset_0_1px_0_rgba(255,255,255,0.34)] ring-1 ring-white/18 hover:translate-y-0 hover:bg-[linear-gradient(135deg,#8bafff,#6b89ff_58%,#887aff)] hover:shadow-[0_16px_42px_-16px_rgba(96,125,255,1),inset_0_1px_0_rgba(255,255,255,0.4)] active:scale-[0.98] sm:h-11 sm:min-w-[11.25rem] sm:px-4 sm:text-[15px]"
            )}
          >
            <span className="sm:hidden">Run</span>
            <span className="hidden sm:inline">Run Labels Now</span>
            <ArrowRight className="size-4 rounded-full bg-black/10 p-0.5 sm:size-5" strokeWidth={2.2} aria-hidden />
          </Link>
        </div>
      </header>
